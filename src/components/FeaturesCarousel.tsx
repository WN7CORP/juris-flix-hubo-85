...
export const FeaturesCarousel = () => {
  ...
  return (
    <div 
      className="relative h-[220px] sm:h-[260px] w-full overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700/50" 
    ...
    >
      ...
      <div className="relative z-10 flex h-full items-center px-8 sm:px-10">
        <div className="max-w-2xl text-white">
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-100 drop-shadow-lg animate-fade-in-up leading-relaxed" 
             style={{ animationDelay: '0.2s' }}>
            {currentItem.description}
          </p>
          
          {/* Professional accent line */}
          <div className="mt-6 w-24 h-1.5 bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 rounded-full animate-fade-in-up shadow-lg" 
      ...
      <Button 
        ...
        size="sm" 
        onClick={prevSlide} 
        className="absolute left-4 top-1/2 transform -translate-y-1/2 z-20 bg-black/30 hover:bg-black/50 text-white border-0 rounded-full w-12 h-12 p-0 backdrop-blur-sm transition-all duration-300 hover:scale-110"
      >
      ...
      <Button 
        ...
        size="sm" 
        onClick={nextSlide} 
        className="absolute right-4 top-1/2 transform -translate-y-1/2 z-20 bg-black/30 hover:bg-black/50 text-white border-0 rounded-full w-12 h-12 p-0 backdrop-blur-sm transition-all duration-300 hover:scale-110"
      >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-slate-800/50">
        <div 
          className="h-full bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 transition-all duration-500 shadow-lg shadow-amber-400/30" 
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-16 right-20 w-1 h-1 bg-white/40 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-10 right-16 w-1.5 h-1.5 bg-amber-400/40 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
    </div>
  );
};
